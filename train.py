...
if __name__ == "__main__":
    ...
    # model   = DBSegNet(num_classes=num_classes, phi=phi, pretrained=pretrained)
    model   = DBSegNet(num_classes=num_classes, phi='cvmv_tiny_fast',
             fusion_mode='sum', branch='cnn', force_no_ca=False, return_aux=False)
    if not pretrained:
        weights_init(model)
    if model_path != '':
        #------------------------------------------------------#
